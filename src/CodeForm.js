  ...
  return (
    <div className='min-h-64 min-w-96 rounded-lg bg-customeGrey/50 flex items-center justify-center'>        
      <form id="roomForm" onsubmit="handleSubmit(event)" className='flex flex-col items-center'>
        ...
        <button type="submit" onClick={() => navigate('/dd')} className='py-2 text-2xl font-semibold bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white w-full max-w-xs rounded-md'>
          Let's Gooo
        </button>
      </form>
    </div>
